...
// Here I would normally add a few examples of Track data.
// One goal being to provide a large amount of variety for SwiftUI previews.

extension Track {
    static let pumpedUpKicks = Track(
        wrapperType: "track",
        kind: "song",
        artistId: 414023649,
